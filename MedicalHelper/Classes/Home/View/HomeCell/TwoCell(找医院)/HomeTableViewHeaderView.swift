...
class HomeTableViewHeaderView: UITableViewHeaderFooterView {
    ...
    override func layoutSubviews() {
        ...
        //布局
        topLineImageView.frame = CGRect(x: 0, y: 0, width: kScreenWidth, height: 0.5)
        bottomLineImageView.frame = CGRect(x: 0, y: contentView.bounds.height - 1, width: kScreenWidth, height: 0.5)
    }
